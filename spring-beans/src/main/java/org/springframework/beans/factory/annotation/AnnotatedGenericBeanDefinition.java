 ...
 * 1。继承GenericBeanDefinition-->是GenericBeanDefinition的扩展
 * 2。实现了AnnotatedBeanDefinition接口-->提供了获取注解元数据的支持,getMetadata()和getFactoryMethodMetadata()
 * <p>
 * <p>
...
public class AnnotatedGenericBeanDefinition extends GenericBeanDefinition implements AnnotatedBeanDefinition {
    ...
    public AnnotatedGenericBeanDefinition(Class<?> beanClass) {
        /**
         * 调用抽象类AbstractBeanDefinition的setBeanClass()方法设置bean定义的beanClass属性
         */
