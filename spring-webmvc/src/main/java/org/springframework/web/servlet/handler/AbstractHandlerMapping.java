...
public abstract class AbstractHandlerMapping extends WebApplicationObjectSupport
    ...
    /**
     * doDispatch：获取HandlerExecutionChain对象
     * <p>
    ...
    public final HandlerExecutionChain getHandler(HttpServletRequest request) throws Exception {
        /**
         * 1。getHandlerInternal交给子类去实现，比如AbstractUrlHandlerMapping，根据url找到对应的controller-->HandlerExecutionChain
         * 此时返回的已经是封装好的HandlerExecutionChain执行链对象
         */
        Object handler = getHandlerInternal(request);
        if (handler == null) {
            // 如果没有找到 使用默认的handler 开发人员可以自己设置默认的handler
        ...
        /**
         * 2。将配置中的拦截器添加到HandlerExecutionChain执行链中
         */
