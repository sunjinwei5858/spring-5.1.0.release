...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
    ...
    /**
     * 这里进行添加beanFactoryPostProcessor 和自己实现的
     *
    ...
    protected ConfigurableListableBeanFactory obtainFreshBeanFactory() {
        /**
         * ！！！
         * 注解方法配置调用的是GenericApplicationContext的refreshBeanFactory
         * xml方式配置调用的是AbstractRefreshableApplicationContext的refreshBeanFactory
         */
        refreshBeanFactory();
        return getBeanFactory();
    }
    ...
    /**
     * 该方法是将常用的一些类注入到spring容器当中，并不是存储在singltonObjects这个map当中
     * 而是存储在resolvableDependencies 这个容器当中
     * Map<Class<?>, Object> resolvableDependencies = new ConcurrentHashMap<>(16);
     * 比如BeanFactory ResourceLoader ApplicationEventPublisher ApplicationContext
     * <p>
    ...
    /**
     * 实例化和调用BeanFactoryPostProcessor的方法
     * <p>
     * 必须在singleton实例化之前回调
    ...
    protected void finishBeanFactoryInitialization(ConfigurableListableBeanFactory beanFactory) {
        ...
        /**
         * 冻结所有的bean定义，说明注册的bean将不被修改或者任何进一步的处理
         */
