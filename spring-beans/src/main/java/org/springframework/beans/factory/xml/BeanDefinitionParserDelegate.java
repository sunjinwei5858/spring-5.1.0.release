...
public class BeanDefinitionParserDelegate {
     ...
     * spring的主要工作：
     * 1。提取元素中的id和name属性
     * 2。进一步解析其他属性并统一封装到GenericBeanDefinition类型的BeanDefinition
     * 3。如果没有beanName 那么使用默认规则为此bean生成一个beanName
    ...
    public BeanDefinitionHolder parseBeanDefinitionElement(Element ele, @Nullable BeanDefinition containingBean) {
        ...
        /**
         * 2。进一步解析其他属性并统一封装到GenericBeanDefinition类型的BeanDefinition
         *  内部使用的是工具类BeanDefinitionReaderUtils.createBeanDefinition()创建
         */
        ...
        if (beanDefinition != null) {
            ...
            if (!StringUtils.hasText(beanName)) {
                // 如果不存在beanName 那么根据spring的规则生成一个对应的beanName
                try {
                    if (containingBean != null) {
    ...
    public AbstractBeanDefinition parseBeanDefinitionElement(
        ...
        try {
            /**
             * 创建GenericBeanDefinition类型的BeanDefinition
             */
    ...
    public AbstractBeanDefinition parseBeanDefinitionAttributes(
        ...
        /**
         * 1解析scope属性 注意：
         * 之前的版本：scope和singleton两个属性只能指定其一 不可以同时出现，
         * 但是当前的版本更新为只能出现scope属性
         */
