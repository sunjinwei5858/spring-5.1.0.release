...
/**
 * spring事务的解析器，实现了BeanDefinitionParser接口。
 * spring默认所有的代理都是jdk代理。这可能会导致一些问题 如果注入一些实现类
 * <p>
 * <p>
...
class AnnotationDrivenBeanDefinitionParser implements BeanDefinitionParser {
     ...
     * <p>
     * 注册了代理类及3个bean，这三个bean支撑了spring的事务
     */
    private static class AopAutoProxyConfigurer {
        ...
        public static void configureAutoProxyCreator(Element element, ParserContext parserContext) {
            ...
            /**
             * 注册后置处理器：InfrastructureAdvisorAutoProxyCreator
             */
            ...
            if (!parserContext.getRegistry().containsBeanDefinition(txAdvisorBeanName)) {
                ...
                /**
                 * 第一个bean：TransactionAttributeSource：sourceDef
                 */
                ...
                /**
                 * 第二个bean:TransactionInterceptor：interceptorDef
                 */
                ...
                /**
                 * 第三个bean:TransactionAttributeSourceAdvisor：advisorDef
                 */
