...
public abstract class AbstractDispatcherServletInitializer extends AbstractContextLoaderInitializer {
    ...
    /**
     * 作为WebApplicationInitializer子类，继承了抽象类AbstractContextLoaderInitializer，
     * 这里有两段功能：
     * 一个是调用父类super.onStartup(servletContext)：创建根容器+注册listener
     * 一个是调用子类注册DispatcherServlet+filter
     *
