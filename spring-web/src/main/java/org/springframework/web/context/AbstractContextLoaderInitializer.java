...
public abstract class AbstractContextLoaderInitializer implements WebApplicationInitializer {
    ...
    protected void registerContextLoaderListener(ServletContext servletContext) {
        ...
        if (rootAppContext != null) {
            ...
            ApplicationContextInitializer<?>[] rootApplicationContextInitializers = getRootApplicationContextInitializers();
            listener.setContextInitializers(rootApplicationContextInitializers);
            // 将ContextLoaderListener添加到servletContext
