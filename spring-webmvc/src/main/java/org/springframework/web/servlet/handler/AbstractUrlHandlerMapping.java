...
public abstract class AbstractUrlHandlerMapping extends AbstractHandlerMapping implements MatchableHandlerMapping {
    ...
    /**
     * 根据url路径找到对应的HandlerExecutionChain
     * <p>
    ...
    protected Object getHandlerInternal(HttpServletRequest request) throws Exception {
        ...
        // 2 根据url寻找HandlerExecutionChain
    ...
    /**
     * 根据url找到HandlerExecutionChain：代码虽然长，但是逻辑并不复杂，这里分为两种情况：精确匹配和通配符匹配
     *
     * 根据url-->beanName-->controller-->HandlerExecutionChain
     *
     * <p>
    ...
    protected Object lookupHandler(String urlPath, HttpServletRequest request) throws Exception {
        // Direct match?
        /**
         * 1 情况一：直接匹配 根据url直接匹配到beanName
         */
        Object handler = this.handlerMap.get(urlPath);
        /**
         * 去spring子容器中根据beanName找controller
         */
        if (handler != null) {
            // Bean name or resolved handler?
    ...
    /**
     * 构建HandlerExecutionChain对象，将Handler作为参数传入，并且加入拦截器，
     * 如果是精确匹配 加入一个拦截器；通配符匹配还要加入一个拦截器
     *
     *
