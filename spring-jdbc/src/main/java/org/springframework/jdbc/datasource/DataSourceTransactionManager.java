    ...
    protected void doBegin(Object transaction, TransactionDefinition definition) {
        ...
        try {
            if (!txObject.hasConnectionHolder() || txObject.getConnectionHolder().isSynchronizedWithTransaction()) {
                // 1 获取连接Connection 将connection封装到ConnectionHolder对象
            ...
            /**
             * 3 更改默认的提交设置，将提交操作委托给spring管理，
             * 这也是为什么spring管理事务的非常重要的一点，因为事务提交交给spring了，所以事务被spring管理了
             */
            ...
            // 6 Bind the connection holder to the thread 将connectionHolder绑定到当前线程
