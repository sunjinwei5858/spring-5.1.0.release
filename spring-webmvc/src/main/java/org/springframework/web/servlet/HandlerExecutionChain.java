...
/**
 * HandlerExecutionChain对象封装了：handler，interceptors
 *
 * spring费尽周折，将handler封装为HandlerExecutionChain，这是一种链处理机制，是spring常用的方式，比如aop代理对象执行目标的时候也是采用链处理机制
 * 这是非常优秀的设计
 *
 *
